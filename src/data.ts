...
export const SERVICES = [
  {
    title: "UI/UX Design",
    desc: "Clean, user-friendly designs that improve engagement and experience.",
    icon: "monitor",
  },
  {
    title: "Graphic Design",
    desc: "Visual content that communicates ideas and builds brand identity.",
    icon: "pen",
  },
  {
    title: "Video Editing",
    desc: "Engaging videos and reels that tell stories and connect with your audience.",
    icon: "play",
  },
  {
