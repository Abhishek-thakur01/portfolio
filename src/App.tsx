            ...
            {status === "sent" ? (
              ...
              <form onSubmit={submit} className="space-y-4">
                <div className="grid gap-4 sm:grid-cols-2">
                  <input value={form.name} onChange={(e) => setForm({ ...form, name: e.target.value })} placeholder="Your Name" required className="w-full rounded-xl border border-white/10 bg-[#06080f] px-4 py-3 text-sm text-white outline-none focus:border-[#8b7cff]" />
                  <input type="email" value={form.email} onChange={(e) => setForm({ ...form, email: e.target.value })} placeholder="Your Email" required className="w-full rounded-xl border border-white/10 bg-[#06080f] px-4 py-3 text-sm text-white outline-none focus:border-[#8b7cff]" />
                </div>
                <textarea value={form.message} onChange={(e) => setForm({ ...form, message: e.target.value })} placeholder="Your Message" required rows={5} className="w-full rounded-xl border border-white/10 bg-[#06080f] px-4 py-3 text-sm text-white outline-none focus:border-[#8b7cff]" />
